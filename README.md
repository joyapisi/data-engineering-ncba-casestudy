...
a. **Process for Designing and Architecting a Data Warehouse Tailored to MSL’s needs (10 marks)** <a name="VPN"></a>
...
- Scalability: Ensures scalability across multiple regions as MSL expands for multi-tenant architecture


b. **Key Steps in Building the Data Warehouse (10 marks)** <a name="MPLS"></a>
...
c. **Approach to ETL (10 marks)** <a name="OSPF"></a>
...
d. **Managing ETL Scheduling for Daily Refreshes (5 marks)** <a name="BGP"></a>
...
5. Servicing Analytics Needs Across Teams (5 marks)
...
6. Monitoring ETL Pipelines (5 marks)
...
7. Controls for Data Integrity (5 marks)
...
CASE STUDY 2: 
1. Key Factors for Evaluating a Suitable Platform (10 marks)
...
Determine the Platform Based on Data Sources (Log Files, Social Media, Cloud, etc.): 
...
2. Approach to Integrating Data from Multiple Sources (10 marks)
...
3. Roadmap for Migrating Data from Legacy Systems (10 marks)
Phase 1: Assessment
...
Roadmap for Migrating Data from Legacy Systems (10 marks)
Phase 1: Assessment – I would map legacy schemas from on-prem PostgreSQL to cloud-based Redshift while classifying data into hot (3 months), warm (2 years), and cold (up to 7 years) for optimal storage and performance.
Phase 2: ETL Refactoring – Outdated cron jobs would be converted to Apache Airflow DAGs, ensuring efficient scheduling, while heavy ETL jobs run at night, reports are generated at the aggregate layer, and calculations are done once to improve efficiency.
Phase 3: Parallel Run & Validation – The new platform would run alongside the legacy system for 3 months, allowing validation while implementing real-time processing, BI tools, and ML models for risk scoring, fraud detection, and personalized marketing.
Phase 4: Full Cutover – I would freeze the legacy system, migrate the final delta, switch queries to the new infrastructure, and ensure auto-scaling, disaster recovery, and query optimization for a seamless transition.
Phase 5: Evaluating Success of the New Platform – Success would be measured by query speed (10x faster), cost reduction (30% savings), user adoption (faster insights), fewer failures, and lower running costs compared to the legacy system.

5. Optimizing System Performance & Ensuring Business Continuity (5 marks)
...
6. Evaluating Success of New Platform vs. Legacy (5 marks)
